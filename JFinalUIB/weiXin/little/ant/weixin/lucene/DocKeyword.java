	...
	protected IndexWriter getDiskIndexWriter() {
		try {
			...
			if (null == diskIndexWriter) {
				IndexWriterConfig indexWriterConfig = new IndexWriterConfig(Version.LUCENE_4_10_2, analyzer);// 索引分词配置
	...
	protected IndexWriter getRamIndexWriter() {
		try {
			...
			if(null == ramIndexWriter){
				IndexWriterConfig ramConfig = new IndexWriterConfig(Version.LUCENE_4_10_2, analyzer);
