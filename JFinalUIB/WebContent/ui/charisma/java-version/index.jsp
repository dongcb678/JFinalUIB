					...
					<div class="box-content">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="info">
								...
								<p>Its a fully featured, responsive template for your admin panel. Its optimized for tablet and mobile phones. Scan the QR code below to view it in your mobile device.</p> <img alt="QR Code" class="charisma_qr center" src="${pageScope.cxt}/ui/charisma/img/qrcode136.png" />
							</div>
					...
					<div class="box-content">
						<div class="box-content">
							<ul class="dashboard-list">
								...
								<li>
									<a href="#">
										<img class="dashboard-avatar" alt="Abdullah" src="http://www.gravatar.com/avatar/http://www.gravatar.com/avatar/46056f772bde7c536e2086004e300a04.png?s=50"></a>
