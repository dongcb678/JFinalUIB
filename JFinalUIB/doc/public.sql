...
INSERT INTO "public"."pt_module" VALUES ('c87c35097a2d4bc898fe6e9b1e280a3d', null, null, '5.png', 'true', '位置管理', '5', '8a40c0353fa828a6013fa898d4ac1100', null);
...
;
COMMENT ON COLUMN "public"."wx_message"."inout" IS '0接收，1发出';
...
COMMENT ON COLUMN "public"."wx_message"."precision" IS '地理位置精度';
