...
public class TestBase {
    ...
    public static void setUpBeforeClass() throws Exception {
		...
		arpMain = new ActiveRecordPlugin(ConstantPlatform.db_dataSource_main, druidPlugin);
		//arp.setTransactionLevel(4);//事务隔离级别
		arpMain.setDevMode(Boolean.parseBoolean((String) PropertiesPlugin.getParamMapValue(ConstantPlatform.config_devMode))); // 设置开发模式
		arpMain.setShowSql(Boolean.parseBoolean((String) PropertiesPlugin.getParamMapValue(ConstantPlatform.config_devMode))); // 是否显示SQL
