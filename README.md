...
GIT版本分支一共有3个：
	...
	master：JFinalUIB_V2代码，基于常规的eclipse和idea项目配置文件构建
	JFinalUIB_V2_MAVEN：基于maven环境构建的JFinalUIB_V2，代码进行了maven模块化切分
	JFinalUIB_V1：老版本，几乎停止维护
...
下面是基于JFinalUIB_V2进行讲解的JFinal原创著作
《JFinal极速开发实战》
